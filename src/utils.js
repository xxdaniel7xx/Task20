...
//   for (let i =0; userName.ready.length == 0; i++) {
//     userName.ready[i]
//     ready.appendChild(userName.ready[i])
//   }
//   for (let i =0; userName.inProgress.length == 0; i++) {
//     userName.inProgress[i]
//     inProgress.appendChild(userName.inProgress[i])
//   }
//   for (let i =0; userName.finished.length == 0; i++) {
//     userName.finished[i]
//     finished.appendChild(userName.finished[i])
//   }
// }
...
export function taskGen() {
  ...
  inputTask.value = '';
  addDelBtns.removeChild(inputTask);
